  ...
  constructor(
    ...
    this.service
      ...
      .onGet(async () => {
        ...
        const {
          sensors: { ThermostatOperatingState },
        } = thermostat;

        return ThermostatOperatingState === 'Idle'
          ? api.hap.Characteristic.CurrentHeatingCoolingState.OFF
          : api.hap.Characteristic.CurrentHeatingCoolingState.COOL;
      });
    ...
    this.service
      ...
      .onGet(async () => {
        ...
        const modeMap: Record<
          (typeof thermostat)['sensors']['ThermostatMode'],
          number
        > = {
    ...
    this.service
      ...
      .onGet(async () => {
        ...
        return thermostat?.sensors.Temperature.unit === 'C'
          ? characteristic.CELSIUS
          : characteristic.FAHRENHEIT;
      });
